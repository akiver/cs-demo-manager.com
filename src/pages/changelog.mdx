...
:::danger
A CS2 update released a few hours before the release of v3.20.0 synced the game with the latest Source 2 engine and
introduced breaking changes that prevent watching demos from the app.  
A fix will not be available for at least a week and a half as I will not have access to a Windows machine until then.
It means that the release of v3.20.0 is delayed until I can fix the playback issue.
:::
