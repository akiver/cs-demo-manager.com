...
- Added support for automatically unzipping demos from archives (zip, gz and bz2).
  :::warning
  This feature is disabled by default as it may slow down loading demos in folders that contain archives.  
  You can enable auto-unzipping for each archive type in the **Folders** settings tab.
  :::
